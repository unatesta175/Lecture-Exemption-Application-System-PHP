...
if (isset($_POST['submit'])) {
   ...
   $ic = htmlspecialchars(strip_tags(trim($_POST['ic'])), ENT_QUOTES, 'UTF-8');
   ...
   $studno = htmlspecialchars(strip_tags(trim($_POST['studno'])), ENT_QUOTES, 'UTF-8');
   $program_id = htmlspecialchars(strip_tags(trim($_POST['program_id'])), ENT_QUOTES, 'UTF-8');
   $faculty_id = htmlspecialchars(strip_tags(trim($_POST['faculty_id'])), ENT_QUOTES, 'UTF-8');
   $part = htmlspecialchars(strip_tags(trim($_POST['part'])), ENT_QUOTES, 'UTF-8');
   $phoneno = htmlspecialchars(strip_tags(trim($_POST['phoneno'])), ENT_QUOTES, 'UTF-8');
   $homephoneno = htmlspecialchars(strip_tags(trim($_POST['homephoneno'])), ENT_QUOTES, 'UTF-8');
