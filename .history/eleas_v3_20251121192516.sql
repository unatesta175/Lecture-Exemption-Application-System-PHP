...
(1, 'ADMIN 1', 12321421, 'admin1@gmail.com', '6216f8a75fd5bb3d5f22b6f9958cdede3fc086c2', '2132131'),
...
(8, 'ZETTY NATAMULIA BINTI ELIAS', 1234567890, 'admin6@gmail.com', '6216f8a75fd5bb3d5f22b6f9958cdede3fc086c2', '2132131');
...
INSERT INTO `programs` (`program_id`, `clerk_id`, `program_code`, `program_name`, `faculty_code`, `faculty_name`, `faculty_id`) VALUES
(1, 7, 'ACC110', 'Diploma Perakaunan', 'FAC', 'Fakulti Perakaunan', 1),
(2, 7, 'ACC220', 'Sarjana Muda Perakaunan (Kepujian)', 'FAC', 'Fakulti Perakaunan', 1),
(3, 8, 'BA111', 'Diploma Pengajian Perniagaan', 'FPP', 'Fakulti Pengurusan Dan Perniagaan', 4),
(4, 8, 'BA114', 'Diploma Analisis Pelaburan', 'FPP', 'Fakulti Pengurusan Dan Perniagaan', 4),
(5, 8, 'BA119', 'Diploma Pengajian Perbankan', 'FPP', 'Fakulti Pengurusan Dan Perniagaan', 4),
(6, 4, 'BA240', 'Sarjana Muda Pentadbiran Perniagaan (Kepujian) Pemasaran', 'FPP', 'Fakulti Pengurusan Dan Perniagaan', 4),
(7, 4, 'BA242', 'Sarjana Muda Pentadbiran Perniagaan (Kepujiaan) Kewangan', 'FPP', 'Fakulti Pengurusan Dan Perniagaan', 4),
(8, 4, 'BA249', 'Sarjana Muda Pentadbiran Perniagaan (Kepujian) Perbankan Islam', 'FPP', 'Fakulti Pengurusan Dan Perniagaan', 4),
(9, 4, 'BA251', 'Sarjana Muda Pentadbiran Perniagaan (Kepujian) Pengurusan Pelaburan', 'FPP', 'Fakulti Pengurusan Dan Perniagaan', 4),
(10, 6, 'BA252', 'Sarjana Muda Pemasaran Digital (Kepujian)', 'FPP', 'Fakulti Pengurusan Dan Perniagaan', 4),
(11, 5, 'CDCS110', 'Diploma Sains Komputer', 'KPPIM', 'Kolej Pengajian Pengkomputeran, Informatik Dan Media', 5),
(12, 5, 'CDCS143', 'Diploma Sains Matematik', 'KPPIM', 'Kolej Pengajian Pengkomputeran, Informatik Dan Media', 5),
(13, 5, 'CDIM110', 'Diploma Pengurusan Maklumat', 'KPPIM', 'Kolej Pengajian Pengkomputeran, Informatik Dan Media', 5),
(14, 5, 'CD1M261', 'Sarjana Muda Sains Maklumat (Kepujian) Pengurusan Rekod ', 'KPPIM', 'Kolej Pengajian Pengkomputeran, Informatik Dan Media', 5),
(15, 7, 'LG120', 'Diploma Bahasa Inggeris Komunikasi Profesional', 'APB', 'Akademi Pengajian Bahasa', 2),
(16, 6, 'IC220', 'Sarjana Muda Pengurusan Industri Halal (Kepujian)', 'ACIS', 'Akademi Pengajian Islam Kontemporari', 3);
