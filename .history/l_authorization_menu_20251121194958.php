...
<td>'; ?>
                                                    ...
                                                    // Show colored badges for authorization status
                                                    if (strtolower($authorization_status) === 'dibenarkan') {
                                                        echo '<span class="badge bg-success">' . htmlspecialchars($authorization_status) . '</span>';
                                                    } elseif (strtolower($authorization_status) === 'tidak dibenarkan' || strtolower($authorization_status) === 'tidakdibenarkan') {
