...
<br>
            ...
            <input type="password" id="passLogin" name="pass" required placeholder="" maxlength="40" class="box"
                ...
                <label class="larger-font bigger" style="display: flex;flex-direction: row;" for="passLogin">Kata Laluan</label>
<div class="password-container">
  ...
  <i style="font-size:160%;"id="togglePassword" class="fas fa-eye"></i>
            ...
            <a style="border-radius:15px; text-transform:uppercase;" href="user_register.php"
                class="underline option-btn">Daftar</a>
                <!-- <label class="larger-font bigger" style="display: flex;flex-direction: row;" for="emailLogin">Kategori pengguna</label> -->
