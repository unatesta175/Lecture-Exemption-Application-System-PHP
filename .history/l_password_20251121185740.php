...
if (isset($_POST['submit'])) {
    ...
    $fetch_pass_stmt = $conn->prepare("SELECT password FROM lecturers WHERE lecturer_id = ?");
    $fetch_pass_stmt->execute([$lecturer_id]);
    ...
    if ($old_pass == $empty_pass) {
        ...
        $update_stmt = $conn->prepare("UPDATE `lecturers` SET password = ? WHERE lecturer_id = ?");
        $update_stmt->execute([$new_pass, $lecturer_id]);
