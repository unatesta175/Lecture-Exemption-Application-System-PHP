...
<header class="header">
   ...
   <a href="home.php"><img class=" underline"  style=" margin-top: 10px;
      ...
      <nav class="navbar">
         <a href="kpp_home.php" class="underline"><i class="fa fa-home fa-fw" style="margin-right:15px"></i>ANJUNG</a>
         <a href="kpp_support_menu.php" class="underline"><i class="fa fa-sliders fa-fw"
               style="margin-right:15px"></i>PERMOHONAN</a>
         <a href="kpp_update_profile.php" class="underline"><i class="fa fa-database fa-fw"
      ...
      <div class="profile">
         <?php
         $select_profile = $conn->prepare("SELECT * FROM `kpps` WHERE kpp_id = ?");
         $select_profile->execute([$kpp_id]);
         if ($select_profile->rowCount() > 0) {
            ...
            <a href="kpp_update_profile.php" style="border-radius:15px; text-transform:uppercase; "
               class="btn underline">Kemaskini profile</a>
            <div class="flex-btn">
               <a href="kpp_login.php" style="border-radius:15px; text-transform:uppercase; "
                  class="option-btn underline">Login</a>
            </div>
            <a href="components/kpp_logout.php" style="border-radius:15px; text-transform:uppercase; "
            ...
            <div class="flex-btn">
               <a href="kpp_register.php" style="border-radius:15px; text-transform:uppercase; "
