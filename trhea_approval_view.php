                    ...
                    <div id="parent" style="display:flex; flex-direction:row;">
                        ...
                        if ($result2->rowCount() > 0) {
                            while ($row2 = $result2->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                $date_approved = $row2['date_approved'];
                        ...
                        if ($result3->rowCount() > 0) {
                            while ($row3 = $result3->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                $result4 = $conn->prepare("SELECT * FROM `programs` WHERE program_code=?");
                                    $result4->execute([$program_code]);
                                    if ($result4->rowCount() > 0) {
                                        while ($row4 = $result4->fetch(PDO::FETCH_ASSOC)) {
                                            $faculty_code = $row4['faculty_code'];
                        ...
                        if ($result4->rowCount() > 0) {
                            ...
                            <?php
                                    ...
                                    <!-- 
                                    <H5 style="color: black;">Tarikh/Masa dibenarkan : </H5>
                                    <input disabled type="text" id="sticker" name="sticker"
                                        placeholder="Isi nombor plat kenderaan" class="form-control mb-2 bigger"
                                        value="<?php echo $date_authorized; ?>">
                                    <H5 style="color: black;">Status kebenaran : </H5>
                                    <input disabled type="text" id="sticker" name="sticker"
                                        placeholder="Isi nombor plat kenderaan" class="form-control mb-2 bigger"
                                        value="<?php echo $authorization_status; ?>">
                                    <H5 style="color: black;">Dibenarkan oleh: </H5>
                                    <input disabled type="text" id="sticker" name="sticker" placeholder=""
                                        class="form-control mb-2 bigger" value="<?php echo $authorizer; ?>"> -->


                                    <br>
                                    <H2 style="color: black;  font-family: 'Roboto Condensed' , sans-serif;">MAKLUMAT
                                        SOKONGAN KETUA PENGARAH PROGRAM : </H2>
                                    <br>

                                    <table style="font-size: 160%;">
                                        <tr>
                                            <td style="padding-right: 45px;">Tarikh Disokong</td>
                                            <td>
                                    ...
                                    <br>
                                    <H2 style="color: black; font-family: 'Roboto Condensed' , sans-serif;">MAKLUMAT
                                        KELULUSAN TIMBALAN REKTOR HAL EHWAL AKADEMIK : </H2>
                                    <br>
                                    ...
                                    <!-- <H5 style="color: black;">Tarikh/Masa diluluskan : </H5>
                                    <input disabled type="text" id="sticker" name="sticker"
                                        placeholder="Isi nombor plat kenderaan" class="form-control mb-2 bigger"
                                        value="<?php echo $date_approved; ?>">
                                    <H5 style="color: black;">Status kelulusan : </H5>
                                    <input disabled type="text" id="sticker" name="sticker"
                                        placeholder="Isi nombor plat kenderaan" class="form-control mb-2 bigger"
                                        value="<?php echo $approval_status; ?>">
                                    <H5 style="color: black;">Diluluskan oleh : </H5>
                                    <input disabled type="text" id="sticker" name="sticker" placeholder=""
                                        class="form-control mb-2 bigger" value="<?php echo $approver; ?>"> -->
