   ...
   <div class="card-body">
      ...
      <p
         ...
         SELAMAT DATANG &nbsp; <span style="font-weight:bold;">
            <?php echo $fetch_profile["lecturer_name"] ?>
         </span></p>
  ...
  -moz-osx-font-smoothing: grayscale;font-size:1em; font-weight:bold;font-family:  'Roboto Condensed', sans-serif; ">
            ...
            <div style="display: flex; align-items: center; justify-content: center; flex-wrap: wrap;">
               <a href="l_authorization_menu.php"
                  ...
                  class="btn me-2 option-btn text-light btn me-1 underline">Validasi Sekarang</a>
               <a href="#footerx"
                  style=" text-transform: uppercase;border-radius: 15px; font-size: 160%; padding: 5px 10px; display: flex; align-items: center; justify-content: center; height: 30px; width: 50%;"
   ...
   <section class="category">
      ...
      <div class="swiper category-slider">
         ...
         <div class="swiper-wrapper">
            ...
            <a href="l_authorization_menu.php" class="swiper-slide slide underline">
            ...
            <a href="l_update_profile.php" class="swiper-slide slide underline">
            ...
            <a href="components/l_logout.php" class="swiper-slide slide underline">
         ...
         <h3>LOG KELUAR</h3>
			...
			<a href="l_password.php" class="swiper-slide slide underline">
