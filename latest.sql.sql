...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 11, 2023 at 08:14 AM
...
(73, 66, 'SITI NUR ANIS SURAYA BINTI MD SAMIRI', '2023-06-07', 'Ahad', '21:31:00', 'ITT320', 'ANIS', 'tibee', 0, 'pending', 'belum', '0000-00-00 00:00:00'),
...
(78, 65, 'SITI NUR ANIS SURAYA BINTI MD SAMIRI', '2023-06-16', 'Selasa', '18:21:00', 'CSC456', 'KEPALA DIA', 'ACHONG', 0, 'pending', 'belum', '0000-00-00 00:00:00');
...
--
ALTER TABLE `applications`
  MODIFY `application_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
...
--
ALTER TABLE `classes`
  MODIFY `class_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
...
--
ALTER TABLE `lecturers`
  MODIFY `lecturer_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
