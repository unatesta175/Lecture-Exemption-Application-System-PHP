...
if (isset($_POST['support'])) {
    ...
    $update = $conn->prepare("UPDATE `applications` SET support_status = ? ,  date_supported = ?  WHERE application_id = ?");
    $update->execute([$support_status,$date_supported, $application_id]);


    ?>
    <script>

        alert('ANDA SUDAH BERJAYA KEMASKINI VALIDASI KULIAH/KELAS INI DENGAN STATUS "Diluluskan"!');
    </script>
    <?php
    ...
    <script>
        ...
        alert('ANDA SUDAH BERJAYA KEMASKINI VALIDASI KULIAH/KELAS INI DENGAN STATUS "Tidak Diluluskan"!');
    </script>
    <?php
}
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-6">
                                    <h1 class="card-title headerContainer" ">KEMASKINI STATUS SOKONGAN PERMOHONAN PENGECUALIAN KULIAH PELAJAR </h3>
                                                                            </div>
